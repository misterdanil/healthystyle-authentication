...
public class ConfirmCode {
	...
	private Long id;
	@Column(nullable = false, unique = true, columnDefinition = "VARCHAR(6) CONSTRAINT CK_valid_confirm_code_token CHECK (token ~ '\\w{6}')")
	...
	public ConfirmCode(String token, User user, Instant issuedAt, Instant expiredAt) {
		super();
		this.token = token;
		this.user = user;
